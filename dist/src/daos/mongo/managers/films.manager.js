...
export default class FilmsManagerMongo {
    constructor() {
    ...
    async getAll() {
        ...
        if (films.length > 0) {
            ...
            throw new CustomError(500, 1, "An unknown error ocurred getting the films");
        }
    }
    async getById(id) {
    ...
    async update(id, data) {
        ...
        if (film) {
            ...
            throw new CustomError(500, 1, "An unknown error ocurred while updating the film");
        }
    }
    async delete() {
        ...
        if (deletedFilms) {
            ...
            throw new CustomError(500, 1, "An unknown error ocurred while deleting the films");
        }
    }
}
